        ...
        <Reveal>
          <Card className="aurora-border relative overflow-hidden p-8 sm:p-10">
            <div className="relative grid items-center gap-8 lg:grid-cols-[auto_1fr_auto]">
              <div className="grid h-20 w-20 place-items-center rounded-[8px] bg-teal-300/10 text-teal-200 ring-1 ring-teal-200/15">
              ...
              <div>
                ...
                <div className="mt-5 flex flex-wrap gap-2 text-sm text-slate-300">
                  <span className="rounded-[8px] border border-white/10 px-3 py-1">ATS friendly</span>
                  <span className="rounded-[8px] border border-white/10 px-3 py-1">Project-led</span>
                  <span className="rounded-[8px] border border-white/10 px-3 py-1">
                    Big Tech focused
                  </span>
                </div>
              </div>
